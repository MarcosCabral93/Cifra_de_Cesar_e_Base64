...
function base64() {
    ...
    if (document.querySelector("#Criptografar").checked)  textoDeSaida.innerHTML = btoa(textoDeEntrada);
    else textoDeSaida.innerHTML = atob(textoDeEntrada);}



    /*   Material de Apoio Utilizado
htts://www.youtube.com/watch?v=utiLWBXmNQU
AUXILIO do Monitor Allan Kildare e companheiros Matheus Luiz e Artur Moreira.
